  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" style="background-color:#050942">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="?pageName=adminFeatures.jsp">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?pageName=sendRequest.jsp">Send Fund Request</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="?pageName=addCategory.jsp">Add Category</a>
        </li>
        <li class="nav-item">
